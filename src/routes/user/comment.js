...
// comment
route.post('/post/:id', multerSingle('commentPicture'), commentAndLikeCtl.createComment)
...
// comment replies
route.post('/rep/post/:id', multerSingle('commentPicture'), commentAndLikeCtl.createCommentRep)
